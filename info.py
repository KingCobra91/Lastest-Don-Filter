...
PICS = (environ.get('PICS', 'https://telegra.ph/file/45f11a5cae84593682a4f.jpg https://telegra.ph/file/baf2ab8458eb4cd014d24.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/07672e763bd4c9553ae3f.jpg")
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-100118819055')
reqst_channel = environ.get('REQST_CHANNEL_ID', '1002133220564')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DONVIJAYS:DONVIJAYS@cluster0.rh3oaxv.mongodb.net/?retryWrites=true&w=majority")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'donvijays')
...
URL = "https://martinv2.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://martinv2.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://martinv2.onrender.com/".format(FQDN)
else:
    URL = "https://martinv2.onrender.com/".format(FQDN)
